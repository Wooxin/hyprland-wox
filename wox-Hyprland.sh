...
EOF
    ...
    echo "正在安装桌面"
    paru -S hyprland btop kitty swww mako waybar wlogout swaylock-effects swayidle pipewire pipewire-alsa pipewire-pulse thunar thunar-volman gvfs xfce4-settings fcitx5 fcitx5-chinese-addons fcitx5-configtool
